...
public class AwsMainActivity extends AppCompatActivity implements View.OnClickListener {
    /** Class name for log messages. */
    private static final String LOG_TAG = AwsMainActivity.class.getSimpleName();
    ...
    public void onClick(final View view) {
                ...
                CallLambdaService callLambdaService = new CallLambdaService();
                callLambdaService.invokeAPI();
